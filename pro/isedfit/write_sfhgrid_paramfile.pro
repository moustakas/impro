...
pro write_sfhgrid_paramfile, sfhgrid, nage=nage, nmonte=nmonte, tau=tau, $
  gamma=gamma, Z=Z, AV=AV, mu=mu, fburst=fburst, dtburst=dtburst, $
  tautrunc=tautrunc, minage=minage, maxage=maxage, mintburst=mintburst, $
  maxtburst=maxtburst, pburst=pburst

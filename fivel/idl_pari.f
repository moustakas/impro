...
c
c CALLING SEQUENCE:
c     call idl_pari(ionum,a,t,weight)
c
c INPUTS:
...
c-
      ...
      subroutine idl_pari(ionum,a,t,weight)
...
c     
     ...
     &        .or. (ionum .eq. 7012)) then

c [N II] ion parameters

c Updated J. Moustakas, 2004 July 7, U of A from the 
c IRAF nebular package

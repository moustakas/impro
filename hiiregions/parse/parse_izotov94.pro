pro parse_izotov94
; jm04jun24uofa
; parse Table 3 from Izotov et al. 1994 into 1994_izotov.dat
    ...
    readcol, outpath+'94izotov/raw_izotov94.dat', galaxy, altgalaxy, oiihb, oiihb_err, oiii4363hb, oiii4363hb_err, $
...
; write out
    ...
    filename = '1994_izotov.sex'
    reference = 'Izotov, Thuan, & Lipovetsky 1994, ApJ, 435, 647'

    openw, lun, outpath+filename, /get_lun
    printf, lun, '## Written by PARSE_IZOTOV94 '+im_today()+'.'

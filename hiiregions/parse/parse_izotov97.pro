pro parse_izotov97
; jm04jun24uofa
; parse Table 3 from Izotov et al. 1997 into 1997_izotov.dat

    outpath = hiiregions_path()

    readcol, outpath+'97izotov/raw_izotov97.dat', galaxy, altgalaxy, oiihb, oiihb_err, oiii4363hb, oiii4363hb_err, $
...
; write out
    ...
    filename = '1997_izotov.sex'
    reference = 'Izotov, Thuan, & Lipovetsky 1997, ApJS, 108, 1'

    openw, lun, outpath+filename, /get_lun
    printf, lun, '## Written by PARSE_IZOTOV97 '+im_today()+'.'

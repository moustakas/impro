pro simulate_ebv_r23oh, snrcut=snrcut, debug=debug, postscript=postscript, $
  noerror=noerror, test=test
; jm06jun12uofa - simulate the effect of reddening on KK04/R23
...
; add noise, compute abundances, assign branches, and plot
    ...
    snr = [50.0,25.0,15.0,10.0,5.0,3.0]
    nsnr = n_elements(snr)

    ebv = findgen((1.5-0.0)/0.05+1)*0.05+0.0
    nebv = n_elements(ebv)

    psname = '/home/ioannis/idl/impro/nebular/simulate_ebv_r23oh.ps'

...
function mf_schechter_random, schechter, minmass=minmass, $
  maxmass=maxmass, nrand=nrand, mass=mass, sortit=sortit
    ...
    while (count lt nrand) do begin
       delvarx, seed1, seed2
       randmass = randomu(seed1,nrand*2)*(maxmass-minmass)+minmass
       prob = mf_schechter(randmass,schechter=schechter)

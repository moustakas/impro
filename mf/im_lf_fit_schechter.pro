...
;-
function im_lf_fit_schechter_func,params,x=x,y=y,err=err
...
;
pro im_lf_fit_schechter,am,phi,phistddev,schechter,mden=mden
...
params=mpfit('im_lf_fit_schechter_func',start,functargs=functargs,perror=perror)
...
mden=im_lf_schechter_mden(schechter)

...
; legend
          label = [$
            ...
            'E(B-V) = '+strtrim(string(isedfit[igal].ebv,format='(F12.3)'),2)+$
            ' ('+strtrim(string(isedfit[igal].ebv_50,format='(F12.3)'),2)+')',$
            ...
            '\psi_{100} = '+strtrim(string(isedfit[igal].sfr100,format='(F12.3)'),2)+$

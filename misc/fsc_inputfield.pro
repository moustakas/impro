...
IF self.cr_only AND (self.event_pro EQ "" AND self.event_pro EQ "") THEN $
...
IF self.focus AND (self.event_pro EQ "" AND self.event_pro EQ "") THEN $
...
field3 = FSC_INPUTFIELD(tlb, Title='String:', LabelSize=50, Value='Coyote Rules!', $
   UValue='Field 3 Event',  /Focus_Events)

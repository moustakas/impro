...
; astroconst.idl:
;  Jeremy Bailin's include file of astrophysics-related
;  constants ready-to-be-included for IDL

; made into an idl function that reads the constants into a structure
;   J. Moustakas, 2002 Aug 1, U of A
...
; assume CGS unless MKS is defined
